...
void Vservant_sim_servant__Mz1_Dz2_S1_Cz3_Az3___nba_sequent__TOP__servant_sim__dut__0(Vservant_sim_servant__Mz1_Dz2_S1_Cz3_Az3* vlSelf) {
            ...
            = ((IData)(vlSymsp->TOP.wb_rst) ? 0U : 
               (((((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__gen_csr__DOT__csr__DOT__i_mret) 
                   ...
                   ? ((~ ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_cnt0) 
                          | (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_cnt1))) 
    ...
    if (vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_en) {
    ...
    if (((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_init)
          ? ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_cnt0) 
             | (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_cnt1))
          : (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_en))) {
        __Vdly__cpu__DOT__cpu__DOT__bufreg__DOT__data 
            = ((0xfffffffcU & __Vdly__cpu__DOT__cpu__DOT__bufreg__DOT__data) 
               | ((2U & (((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_init)
                           ? (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__q)
                           : (vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data 
                              >> 2U)) << 1U)) | (1U 
                                                 & (vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data 
    ...
    vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_signbit_a1 
        = vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_signbit_a0;
    ...
    vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg2__DOT__o_q 
        = (((3U == (3U & vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data)) 
           ...
           | (((2U == (3U & vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data)) 
               & (vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg2__DOT__dlo 
                  >> 0x00000010U)) | (((1U == (3U & vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data)) 
                                       & (vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg2__DOT__dlo 
                                          >> 8U)) | 
                                      ((0U == (3U & vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data)) 
                                       & vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg2__DOT__dlo))));
                  ...
                  & ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__decode__DOT__funct3) 
                     | ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__decode__DOT__funct3) 
                        >> 1U))) | ((vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data 
                                     & (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__decode__DOT__funct3)) 
                                    >> 1U)));
    vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_dat_valid_a0 
        = (1U & (((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__decode__DOT__funct3) 
    ...
    vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_cnt1 
        = ((0U == (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__state__DOT__o_cnt)) 
    ...
    vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_signbit_a0 
        = ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_dat_valid_a0)
            ? (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg2__DOT__o_q)
            : (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_signbit_a1));
        ...
        = ((((1U & (IData)(vlSelfRef.__PVT__cpu__DOT__rf_ram_if__DOT__rcnt))
              ...
              : (0x0000001fU & ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__immdec__DOT__gen_immdec_w_eq_1__DOT__imm19_12_20) 
                                >> 4U))) << 4U) | (0x0000000fU 
                                                   & ((IData)(vlSelfRef.__PVT__cpu__DOT__rf_ram_if__DOT__rcnt) 
                                                      >> 1U)));
    vlSelfRef.__VdfgRegularize_h6e95ff9d_0_3 = ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__i_imm) 
                                                & ((~ 
                                                    ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__decode__DOT__opcode) 
                                                     >> 2U)) 
                                                   & (~ 
            ...
            : ((((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__o_q) 
               ...
               | (((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__gen_csr__DOT__csr__DOT__o_q) 
                  ...
                  | ((((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_dat_valid_a0)
                        ? (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg2__DOT__o_q)
                        : ((~ ((IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__decode__DOT__funct3) 
                               >> 2U)) & (IData)(vlSelfRef.__PVT__cpu__DOT__cpu__DOT__mem_if__DOT__PIPE_signbit_a1))) 
...
void Vservant_sim_servant__Mz1_Dz2_S1_Cz3_Az3___nba_sequent__TOP__servant_sim__dut__1(Vservant_sim_servant__Mz1_Dz2_S1_Cz3_Az3* vlSelf) {
    ...
    vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg2__DOT__i_dat 
        = ((0U != (vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data 
                   >> 0x0000001eU)) ? ((vlSelfRef.__PVT__cpu__DOT__cpu__DOT__bufreg__DOT__data 
                                        >> 0x0000001fU)
                                        ? vlSelfRef.__PVT__timer__DOT__mtime
