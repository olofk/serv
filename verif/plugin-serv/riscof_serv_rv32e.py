...
class serv_rv32e(pluginTemplate):
    __model__ = "serv_rv32e"
    __version__ = "1.4.0"
    ...
    def initialise(self, suite, work_dir, archtest_env):
       ...
       # Use env_rv32e/ which has a model_test.h restricted to x0-x15
       self.compile_cmd = 'riscv64-unknown-elf-gcc -march={0} \
         -static -mcmodel=medany -fvisibility=hidden -nostdlib -nostartfiles -g\
         -T '+self.pluginpath+'/env_rv32e/link.ld\
    ...
    def runTests(self, testList):
      for testentry in testList.values():
          ...
          # Relative to repo root (where riscof must be invoked from)
          exe = 'servant_test_rv32e/Vservant_sim'
